...
export default function Home() {
    return (
        <div className="flex flex-col h-full min-h-dvh container mx-auto">
            <div
                className="relative overflow-hidden flex flex-col h-screen lg:h-auto w-full pt-5 pl-4 pr-4 lg:bg-[#f7f7f7] rounded-2xl">
                <Image className="absolute pointer-events-none opacity-50 z-0 pl-13 pr-13" objectFit="cover" fill
                       src={GridLayout}
                       alt={"grid"}/>

                <Image
                    className="absolute hidden lg:block pointer-events-none z-0 left-1/2 transform-[translateX(-25%)]"
                    src={PhoneMockup} width={1293}
                    height={870} alt={"phone"}/>

                <div className="justify-center md:flex z-10 pr-8 pl-8 w-full h-fit items-center">
                    <nav className="flex text-lg bg-white justify-center items-center rounded-full p-4 pl-7 pr-7">
                        <Image src={Logotype} alt={"logo"} width={48} height={48} className="mr-8 hidden" />
                ...
                <div className="flex items-center text-center z-10 flex-col mt-21">
                    <Image
                        className="mt-4" objectFit="cover" width={140} height={140}
                        src={Logotype}
                        alt={"grid"}
                    />

                    <h2 className="text-2xl lg:text-3xl font-bold mt-8">
                    ...
                    <p className="text-center md:text-xl lg:w-1/2 text-gray-500 mt-4">
                    ...
                    <div className="flex flex-col items-center gap-4 mt-5">
                        <LinkButton classes="order-3" variant="primary" value="Download" ImageComponent={DownloadSvg}/>
                        <LinkButton classes="order-2" variant="outline" value="Open in your browser" ImageComponent={RocketSvg}/>
                    </div>
